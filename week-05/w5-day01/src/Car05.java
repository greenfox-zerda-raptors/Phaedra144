...
public class Car05 {
    ...
    public Car05(String type, String colour) {
        this.type = type;
        this.colour = colour;
        this.kmOdometer = 10;
        this.engine = 1600;
    }
    public Car05(int engine, int kmOdometer) {
        this.engine = engine;
        this.kmOdometer = kmOdometer;
        this.colour = "red";
        this.type = "Mazda";
    }
    public Car05(String type, String colour, int engine, int kmOdometer){
        this.colour = colour;
        this.engine = engine;
        this.type = type;
        this.kmOdometer = kmOdometer;
    ...
    public Car05(String colour, String type, int engine) {
        this.colour = colour;
        this.type = type;
        this.engine = engine;
    }

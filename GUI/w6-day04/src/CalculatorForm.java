        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (e.getSource() == button1) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(CalculatorForm.this, "Please Enter the Right Info", "Error", JOptionPane.ERROR_MESSAGE);
                ...
                if (dollarSign.isSelected()) {
                    ...
                    JOptionPane.showMessageDialog(CalculatorForm.this, numFormat.format(totalCalc), "Solution", JOptionPane.INFORMATION_MESSAGE);
                ...
                // If the comma is selected in the checkbox print the number with commas
                    ...
                    // Defines that you want to format a number with comm
                    ...
                    JOptionPane.showMessageDialog(CalculatorForm.this, totalCalc, "Solution", JOptionPane.INFORMATION_MESSAGE);
